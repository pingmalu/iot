...
void loop()
{
    ...
    if (packetSize)
    {
        ...
        if (len > 0)
        {
            ...
            if((int)packet[3]==2 && (int)packet[2]==1){  // 前
                RUN_SPEED = MAX_SPEED;
            }else if((int)packet[3]==1 && (int)packet[2]==2){  // 后
                RUN_SPEED = -MAX_SPEED;
            }
